...
const slides = [
    {
        ...
        title: ' What We Do? ',
        subtitle: 'Unlimited consultations with Top doctors for your entire family.',
    },
    {
        id: '2',
...
const OnBoarding = () => {
                    ...
                    {currentSlideIndex == slides.length - 1 ? (
                        <View style={{ height: 50 }}>
                            <TouchableOpacity
                                ...
                                <Text style={{ fontWeight: 'bold', fontSize: 16, color: COLORS.secondary, textDecorationLine: 'underline', }}>
                                    GET STARTED
                                </Text>
                            </TouchableOpacity>
                        </View>
    ...
    return (
        ...
        <StatusBar barStyle="dark-content"   backgroundColor={COLORS.onboardbackround}  />
        <FlatList
          ref={ref}
