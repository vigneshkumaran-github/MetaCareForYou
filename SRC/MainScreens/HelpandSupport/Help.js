        ...
        <ScrollView>
          ...
          <View style={{ alignItems: "center", justifyContent: "center" }}>
            ...
            >
              ...
              <Text style={[styles.textMinimum]}>
                It looks like you are experiencing problems with our services through this platform.We are here to help so please get in touch with us.
              </Text>
            </View>
          ...
          <View style={{ width: wp("100%"),marginTop:20 }}>
            <View style={[styles.section]}>
              ...
              <TouchableOpacity onPress={()=>{Linking.openURL(`sms:${'+60 163631793'}`)}} style={[styles.card]}>
                   <Lottie
            ...
            />
             <Text style={[styles.LeftText]}>
              Chat to us
                  ...
                  <TouchableOpacity onPress={()=>{Linking.openURL(`tel:${'+60 163631793'}`)}} style={[styles.card]}>
            ...
            <Text style={[styles.LeftText]}>
              Call to us
                   ...
                   <TouchableOpacity onPress={()=>{Linking.openURL(`mailto:${'metacare4u@gmail.com '}`)}} style={[styles.card]}>
